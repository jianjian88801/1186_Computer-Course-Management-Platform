<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否选择" prop="shifouxuanze">
          <el-select v-model="ruleForm.shifouxuanze" placeholder="请选择是否选择">
            <el-option
                v-for="(item,index) in shifouxuanzeOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否选择" prop="shifouxuanze">
	      <el-input v-model="ruleForm.shifouxuanze"
                placeholder="是否选择" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengmingcheng = true;
          ...
          if(o=='shifouxuanze'){
            this.ruleForm.shifouxuanze = obj[o];
	    this.ro.shifouxuanze = true;
            continue;
          }
          if(o=='xuanzeshijian'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.shifouxuanzeOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
